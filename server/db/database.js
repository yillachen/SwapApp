// Establishing a connection to Postgres by creating a Sequelize instance called `db`
...
const db = new Sequelize(`postgres://localhost:5432/${dbName}`, { // postgres port is 5432
  logging: false,
});
